...
function initData() {
    ...
    $.ajax({
        type: "GET",
        url: "/api/price/buytemplate/find",
        headers: { "token": token },
        async: false,
        success: function (response) {
            if (response.status != 0) {
...
function submitAdd() {
    ...
    $.ajax({
        type: "POST",
        url: "/api/price/buytemplate/create",
        headers: { "token": token },
...
function prepareEdit(id) {
    ...
    $.ajax({
        type: "GET",
        url: "/api/price/buytemplate/findDetail",
        headers: { "token": token },
...
function submit() {
    ...
    $.ajax({
        type: "POST",
        url: "/api/price/buytemplate/edit-price",
        headers: { "token": token },
        data: JSON.stringify(data),
        async: false,
        success: function (response) {
...
function apply() {
    ...
    $.ajax({
        type: "POST",
        url: "/api/price/buytemplate/apply",
        headers: { "token": token },
        data: JSON.stringify(data),
        async: false,
        success: function (response) {
...
function deleteTemplate() {
    ...
    $.ajax({
        type: "POST",
        url: "/api/price/buytemplate/delete",
        headers: { "token": token },
...
function download() {
    ...
    wb.Props = {
        Title: "Template Harga Beli",
        Subject: "Template Harga Beli",
        Author: "UD Tunas Jaya",
        CreatedDate: new Date(2017, 12, 19)
    };

    wb.SheetNames.push("Template Harga Beli");
    dlData = [];
    templateDetailIds = [];
    ...
    wb.Sheets["Template Harga Beli"] = ws;
    ...
    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'template harga beli ' + mapTemplate[selectedTemplateId].name + ' ' + formattedToday + '.xlsx');
    ...
    $.ajax({
        type: "POST",
        url: "/api/price/buytemplate/download",
        headers: { "token": token },
        data: JSON.stringify(data),
        success: function (response) {
            if (response.status != 0) {
...
function submitCopy() {
    ...
    $.ajax({
        type: "POST",
        url: "/api/price/buytemplate/copy",
        headers: { "token": token },
        data: JSON.stringify(data),
        async: false,
        success: function (response) {
